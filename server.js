...
server.put("/api/projects/:id", (req, res) => {
  ...
  projects
    ...
    .catch(err => res.status(400).json({ error: "Cannot update that!" }));
});
...
server.delete("/api/projects/:id", (req, res) => {
  ...
  projects
    ...
    .catch(err => res.status(400).json({ error: "No can do Hombre." }));
});
...
server.put("/api/actions/:id", (req, res) => {
  ...
  actions
    ...
    .catch(err => res.status(400).json({ error: "No can do." }));
});
